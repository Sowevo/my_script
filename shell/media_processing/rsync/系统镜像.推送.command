...
# 定义远程和本地目录的路径
remote_directory="sowevo@10.0.0.3:/share/CACHEDEV2_DATA/Vol2/我的资料/系统镜像/"
local_directory="$script_directory/系统镜像/"
...
# 构建 rsync 命令并输出
# 使用 rsync 同步本地目录到远程目录
rsync_options="-avh --delete --progress"
rsync_command="rsync $rsync_options $local_directory $remote_directory"
