...
const context={document:{createElement:el},L:{polyline:layer,circleMarker:layer,DomEvent:{stopPropagation(){}}},
  fetch:async(url,options)=>{
    ...
    return {ok:true,json:async()=>url.startsWith('/elements')?{tags:{name:'西武新宿線'},geometry:[[[35,139],[35,140]]]}:
...
const controller=context.initJourneyStart(map,{panel,list,restoreList(){list.hidden=true;},busy:()=>false,hasJourney:()=>false,
